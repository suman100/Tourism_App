...
public class Pokhara extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int images[] = {R.drawable.pkr0, R.drawable.pkr1,R.drawable.pkr2};
        ...
        final ImageView imageView1 = (ImageView) findViewById(R.id.image_pkr1);
        ...
        collapsingToolbar.setTitle(" Pokhara ");

        //String url = "https://tropki.com/sites/default/files/styles/large/public/previews/15117/pokhara.jpg?itok=a78IsRUR";
        String url1 = "https://www.welcomenepal.com/imagecache/crop_featured_image/pkr-ss-leisure.jpeg";
        String url2 = "https://d3hne3c382ip58.cloudfront.net/resized/750x420/ghandruk-loop-trek-from-pokhara-tour-2-20893_1510029029.JPG";
        String url3 = "https://travelnewsnepal.com/wp-content/uploads/2015/05/Pokhara.jpg";
...
//     For Database
        ...
        mref = new com.firebase.client.Firebase("https://tourismapp-782d1.firebaseio.com/pokhara");
        mref1 = new com.firebase.client.Firebase("https://tourismapp-782d1.firebaseio.com/pokhara2");
        mref2 = new com.firebase.client.Firebase("https://tourismapp-782d1.firebaseio.com/pokhara3");
        mref3 = new com.firebase.client.Firebase("https://tourismapp-782d1.firebaseio.com/pokhara4");
        ...
        buttonmapktm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Pokhara.this, Map.class));
            }
        });
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        goToLocationZoom(28.2380, 83.9956,13);
    }
