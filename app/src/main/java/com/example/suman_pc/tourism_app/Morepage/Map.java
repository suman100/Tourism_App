...
import com.example.suman_pc.tourism_app.Manifest;
import com.example.suman_pc.tourism_app.Morepage.models.PlaceInfo;
...
public class Map extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
...
//            mGoogleApiClient = new GoogleApiClient.Builder(this)          //for tracking
...
//      mGoogleApiClient.connect();
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo) {
        ...
        mGooglemap.setInfoWindowAdapter(new CustomInfoWindowAdapter(Map.this));
    ...
    private void moveCamera(LatLng latLng, float zoom, String title) {
        ...
        if (!title.equals("My Location")) {                   //my location no marker
            MarkerOptions options = new MarkerOptions()
                    .position(latLng)
                    .draggable(true)
                    .title(title);
